        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <nav className="flex space-x-1 overflow-x-auto scrollbar-hide py-2 md:space-x-8 md:py-0">
            {[
              ...
              { id: 'lines', name: 'My Lines', icon: QrCode, shortName: 'Lines' },
              { id: 'calendar', name: 'Calendar', icon: Calendar, shortName: 'Calendar' },
              { id: 'analytics', name: 'Analytics', icon: TrendingUp, shortName: 'Analytics' },
            ].map((tab) => {
              const Icon = tab.icon;
              return (
                <button
                  ...
                  className={`flex items-center gap-2 py-3 px-3 md:py-4 md:px-1 border-b-2 font-medium text-sm whitespace-nowrap flex-shrink-0 transition-colors ${
                    activeTab === tab.id
